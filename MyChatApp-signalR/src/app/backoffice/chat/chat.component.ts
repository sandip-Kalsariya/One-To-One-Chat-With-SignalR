...
declare var signalR: HubConnectionBuilder;
...
export class ChatComponent implements OnInit, OnDestroy {
    ...
    signalrConn() {
        //Init Connection
        this._hubConnection = new HubConnectionBuilder().withUrl("http://localhost:63742/chatHub?user=" + this.loggedUsername).build();
